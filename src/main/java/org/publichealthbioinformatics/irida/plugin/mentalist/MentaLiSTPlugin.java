 ...
 */
public class MentaLiSTPlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType MENTALIST = new AnalysisType("MENTALIST");

	public MentaLiSTPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new MentaLiSTPluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
